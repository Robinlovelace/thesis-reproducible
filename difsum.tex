...
corrections suggested by Charles Pattie, additional corrections from Michael Batty
...
\section{Corrections from by Michael Batty}
...
in addition to enabling statistical operations, \DIFdelbegin \DIFdel{itâ}\DIFdelend \DIFaddbegin \DIFadd{it'}\DIFaddend s a general programming
