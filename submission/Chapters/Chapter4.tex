...
in \cref{senergyusedata}, as good energy data is vital to
...
Social survey data is made available both as geographically aggregated
...
for spatial microsimulation, at various levels of geographic aggregation. The disadvantage of census
...
to each individual participating in the survey, although this data is generally
...
A very large and detailed example of an geo-referenced individual-level dataset
...
these methods). However, the methods of analysis used to interpret these
data presented in the latter sections of this chapter and in \cref{s:workdes}
...
the data is read line by line, following the
...
The code to read-in the individual-level data is presented in code sample \ref{cusd}.
...
provides estimates of net and gross household incomes and the MSOA level. For the purposes of
...
data is. How much have Nomis data been randomised, and in what way? 
